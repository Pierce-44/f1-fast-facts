...
export default function DriverQualyVsTeamMate({
  ...
  return (
    <div className="w-full h-full rounded-md shadow-mine flex items-center justify-between text-gray-600 min-h-[190px]">
      <div className="h-full w-1/2 flex flex-col justify-start gap-5 ml-2">
        <div className="space-y-2">
          <p className="pl-4 font-semibold pt-5">Qualifying</p>
