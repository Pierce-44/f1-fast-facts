    ...
    <div className="w-full h-full rounded-md shadow-mine text-gray-600 bg-[#5d87ff] space-y-2 p-4 pt-2">
      ...
      <div className="bg-white px-4 rounded-lg">
        <div className="text-sm font-semibold text-gray-500 pt-2 flex items-center">
          ...
          <p>Best:</p>
          <p className="bg-[#ceffde] text-green-600 px-4 py-1.5 rounded font-semibold ml-auto">
            1
          </p>
        </div>
        <div className="text-sm font-semibold text-gray-500 pt-2 flex items-center">
        ...
        <div className="text-sm font-semibold text-gray-500 pt-2 flex items-center">
          ...
          <p>Worst:</p>
          <p className="bg-[#ffe2e2] text-red-600 px-4 py-1.5 rounded font-semibold ml-auto">
            1
          </p>
        </div>
        <div className="text-sm font-semibold text-gray-500 pt-2 flex items-center pb-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 -960 960 960"
          ...
          <p>Average:</p>
          <p className="bg-[#fffbc3] text-yellow-600 px-4 py-1.5 rounded font-semibold ml-auto">
            1
          </p>
        </div>
      </div>
